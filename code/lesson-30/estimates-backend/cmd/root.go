...
import (
	...
	"learn-cljs.com/estimates/internal/app"
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.estimates.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".estimates" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".estimates")
	}
	if bindAddress == "" {
