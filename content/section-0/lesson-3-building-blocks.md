...
the next two lessons, we will hone in on the foundational skill of reading
...
long way towards being able to read the longer code samples in the coming lessons
with ease.
...
First, in this lesson, we will survey the most common syntactic elements of the
language, then in the next lesson we will take a look at how ClojureScript code
...
As we have seen in the examples of the previous lessons, ClojureScript code is
...
The JavaScript interop forms will be covered in a later lesson, so we will defer
...
In this lesson, we got our first real taste of ClojureScript code, surveying the
...
are so critical that the entire next lesson will be devoted to them. We now know
about:
