...
\begin{fquote}[Kelvin Mai][Full-Stack Engineer]Learn ClojureScript covers everything necessary without being overwhelming. The book is perfect for beginners to the language, and it's a resource I wished was around when I got into the world of Clojure and ClojureScript.
\end{fquote}
...
proceeding any farther, we should install Java and Clojure.\index{Clojure} Since
...
\index{data type!symbols}In Lesson 3, we looked very briefly at symbols, which are essentially
...
Processes)}Communicating Sequential
